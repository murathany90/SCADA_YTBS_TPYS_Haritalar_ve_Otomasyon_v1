...
test('YIBITAS-YERKOY integration: mountInteractiveHistoryChart renders 5 panes with correct lengths and pairing', () => {
  ...
  const context = { state: { filters: {}, scada: { capacitySeason: "summer", entityMetricsByKey: new Map(), getNetworkModelMap: () => new Map(), history: new Map(), history24hCache: new Map(), hatVoltageHistoryCache: new Map(), timeMode: "live" } }, SCADA_CONFIG: {}, document: { createElementNS: () => ({ addEventListener: () => {}, removeEventListener: () => {},  setAttribute: () => {}, appendChild: () => {}, append: () => {}, classList: { add: () => {} }, style: {}, getBoundingClientRect: () => ({ width: 920, height: 600 }), remove: () => {} }), createElement: () => ({ addEventListener: () => {}, removeEventListener: () => {},  setAttribute: () => {}, appendChild: () => {}, append: () => {}, classList: { add: () => {} }, style: {}, getBoundingClientRect: () => ({ width: 920, height: 600 }), remove: () => {} }), createDocumentFragment: () => ({ appendChild: () => {}, append: () => {} }), addEventListener: () => {} }, window: { __SCADA_V2_TEST_HOOKS__: {}, addEventListener: () => {}, removeEventListener: () => {}, removeEventListener: () => {} }, SCADA_COMMON: global.SCADA_COMMON, console, setCapacitySeason: () => {}, initScadaCard: () => {} };
